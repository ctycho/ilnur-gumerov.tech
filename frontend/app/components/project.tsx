    ...
    return (
        <>
            <li className='group relative'>
                <Link href={'https://qualy-smile.ru'} className='' target="_blank">
                    <div className={`
                    ...
                    <h2 className={`${props.font.className} mb-2 relative z-10`}>Qualy-smile</h2>
                    <p className='font-sm relative z-10 text-md text-zinc-600 dark:text-zinc-40 mb-4'>Dental clinic based in Kazan, Russia. Application written using React.</p>
                    <div className="relative z-10 flex items-center">
                        ...
                        <span className="h-6 -mt-1 text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">qualy-smile.ru</span>
                    </div>
